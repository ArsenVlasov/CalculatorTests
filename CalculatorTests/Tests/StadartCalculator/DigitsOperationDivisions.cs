...
{
    [TestFixture]
    public class DigitsOperationDivisions: CalculatorSession
    {
        [SetUp]
        ...
        [Test]
        [TestCaseSource(typeof(ArithmeticOperationsSource), nameof(ArithmeticOperationsSource.DigitsDivisons))]
